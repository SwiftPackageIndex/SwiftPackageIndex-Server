...
```
docker run --rm -v "$PWD":/host -w /host --add-host=host.docker.internal:host-gateway registry.gitlab.com/finestructure/spi-base:847e56642a971795e132c9a523a14a285c791bef swift test
```
