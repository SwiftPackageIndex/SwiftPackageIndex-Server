...
```
docker run --rm -v "$PWD":/host -w /host --add-host=host.docker.internal:host-gateway registry.gitlab.com/finestructure/spi-base:3d689578ae824ca65e1580af859655179e0da622 swift test
```
