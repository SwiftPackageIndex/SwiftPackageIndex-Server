    ...
    init(from decoder: Decoder) throws {
        ...
        switch container.allKeys.first! {
            case .executable:
                self = .executable
            case .library:
                let nestedContainer = try container.nestedContainer(keyedBy: AutogeneratedCodingkeys.self, forKey: .library)
    ...
    func encode(to encoder: Encoder) throws {
        ...
        switch self {
            ...
            case let .library(type):
                var nestedContainer = container.nestedContainer(keyedBy: AutogeneratedCodingkeys.self, forKey: .library)
