...
class PublicPage {
    ...
    final func analyticsHead() -> Node<HTML.HeadContext> {
        guard let plausibleDomain = Current.plausibleDomain(),
              let plausibleBaseUrl = Current.plausibleBaseUrl() else {
            return .empty
        }
        return .raw("""
                    ...
                    <script async defer data-domain="\(plausibleDomain)" src="/javascripts/plausible.js"></script>
