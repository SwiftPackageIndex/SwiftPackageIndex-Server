...
enum SearchFilterKey: String, Codable, CaseIterable {
    // FIXME: do we really need to set the strings here? Or if we do, do they need to be different from the SQLIdentifiers?
    ...
    var searchFilter: SearchFilter.Type {
        switch self {
            case .author:
...
extension SearchFilterKey: CustomStringConvertible {
