...
# Build image
# ================================
FROM registry.gitlab.com/finestructure/spi-base:24ac06a943249eb837e56205275a82935646cac6 as build
...
# Run image
# ================================
FROM registry.gitlab.com/finestructure/spi-base:24ac06a943249eb837e56205275a82935646cac6
