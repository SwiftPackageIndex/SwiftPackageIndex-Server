...
# Build image
# ================================
FROM registry.gitlab.com/saguaro1/spi-base:61cadd6ff7539c2a7efdfd15c225590d118b2afb AS build
...
# Run image
# ================================
FROM registry.gitlab.com/saguaro1/spi-base:61cadd6ff7539c2a7efdfd15c225590d118b2afb
