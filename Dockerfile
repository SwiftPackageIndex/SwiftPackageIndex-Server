...
# Build image
# ================================
FROM registry.gitlab.com/finestructure/spi-base:3d689578ae824ca65e1580af859655179e0da622 AS build
...
# Run image
# ================================
FROM registry.gitlab.com/finestructure/spi-base:3d689578ae824ca65e1580af859655179e0da622
