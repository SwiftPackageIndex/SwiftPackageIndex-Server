            ...
            buildGroups: [
                .init(
                    ...
                    builds: [
                        ...
                        .init(id: Self.id, swiftVersion: .v5_4, platform: .macosSpmArm,        status: .timeout),
                        .init(id: Self.id, swiftVersion: .v5_4, platform: .macosXcodebuildArm, status: .infrastructureError),
                        ...
                        .init(id: Self.id, swiftVersion: .v5_3, platform: .macosSpmArm,        status: .timeout),
                        .init(id: Self.id, swiftVersion: .v5_3, platform: .macosXcodebuildArm, status: .infrastructureError),
