...
extension ShellOutCommand {
    ...
    var isCreateSwiftDumpPackageContainer: Bool {
        description.contains("docker create --name=swift-dump-package")
    }

    var isStartSwiftDumpPackageContainer: Bool {
        description.contains("docker start --attach swift-dump-package")
    }

    var isRemoveSwiftDumpPackageContainer: Bool {
        description.contains("docker rm --force swift-dump-package")
    }
}
