...
class PackageController_routesTests: AppTestCase {
    ...
    func test_awsDocumentationURL() throws {
        ...
        XCTAssertEqual(
            ...
            "http://spi-prod-docs.s3-website.us-east-2.amazonaws.com/foo/bar/main/documentation/path"
        )
        XCTAssertEqual(
            try PackageController.awsDocumentationURL(owner: "Foo", repository: "Bar", reference: "1.2.3", fragment: .css, path: "path").string,
            "http://spi-prod-docs.s3-website.us-east-2.amazonaws.com/foo/bar/1.2.3/css/path"
        )
        XCTAssertEqual(
            ...
            "http://spi-prod-docs.s3-website.us-east-2.amazonaws.com/foo/bar/1.2.3/documentation/path"
        )
        XCTAssertEqual(
        ...
        XCTAssertEqual(
            ...
            "http://spi-prod-docs.s3-website.us-east-2.amazonaws.com/foo/bar/1.2.3/js/path"
        )
        XCTAssertEqual(
            ...
            "http://spi-prod-docs.s3-website.us-east-2.amazonaws.com/foo/bar/1.2.3/theme-settings.json"
        )
    }
