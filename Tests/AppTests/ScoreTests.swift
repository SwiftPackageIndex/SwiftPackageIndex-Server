...
class ScoreTests: AppTestCase {
    ...
    func test_computeBreakdown() throws {
        XCTAssertEqual(Score.computeBreakdown(.init(licenseKind: .none,
                                                    ...
                                                    lastActivityAt: Date.now.adding(days: -400),
        ...
        XCTAssertEqual(Score.computeBreakdown(.init(licenseKind: .compatibleWithAppStore,
                                                    ...
                                                    isArchived: false,
                                                    numberOfDependencies: 2,
                                                    lastActivityAt: Date.now.adding(days: -300),
                                                    hasDocumentation: false,
                                                    hasReadme: false,
                                                    numberOfContributors: 0,
                                                    hasTestTargets: false)).score,
        ...
        XCTAssertEqual(Score.computeBreakdown(.init(licenseKind: .compatibleWithAppStore,
                                                    ...
                                                    isArchived: false,
                                                    numberOfDependencies: 2,
                                                    lastActivityAt: Date.now.adding(days: -100),
                                                    hasDocumentation: false,
                                                    hasReadme: false,
                                                    numberOfContributors: 0,
                                                    hasTestTargets: false)).score,
        ...
        XCTAssertEqual(Score.computeBreakdown(.init(licenseKind: .compatibleWithAppStore,
                                                    ...
                                                    isArchived: false,
                                                    numberOfDependencies: 2,
                                                    lastActivityAt: Date.now.adding(days: -10),
                                                    hasDocumentation: false,
                                                    hasReadme: false,
                                                    numberOfContributors: 0,
                                                    hasTestTargets: false)).score,
