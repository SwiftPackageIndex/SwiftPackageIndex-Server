...
class WebpageSnapshotTests: SnapshotTestCase {
    ...
    func test_HomeIndexView() throws {
        HomeIndex.Model.currentSponsors = [ .init(sponsorName: "Sample Sponsor", logoSource: "/images/logo.png", darkLogoSource: "/images/logo.png", body: "Sponsored links tell everyone about a thing that you can use to do another thing to do!", url: "https://example.com/sponsored/link") ]
        ...
        CommunitySponsors.sponsors = [
            CommunitySponsor(name: "Community Sponsor", avatarUrl: "/images/logo.png"),
            CommunitySponsor(name: "Community Sponsor", avatarUrl: "/images/logo.png"),
            CommunitySponsor(name: "Community Sponsor", avatarUrl: "/images/logo.png"),
            CommunitySponsor(name: "Community Sponsor", avatarUrl: "/images/logo.png"),
            CommunitySponsor(name: "Community Sponsor", avatarUrl: "/images/logo.png"),
